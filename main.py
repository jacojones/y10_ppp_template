...
def menu():
    ...
    while valid == False:
        ...
        try:
            choice = int(input("""
    ____     _   _ U _____ u ____    ____          _____    _   _      _       _____        ____     U  ___ u  _   _     ____   
U /"___|uU |"|u| |\| ___"|// __"| u/ __"| u      |_ " _|  |'| |'| U  /"\  u  |_ " _|      / __"| u   \/"_ \/ | \ |"| U /"___|u 
\| |  _ / \| |\| | |  _|" <\___ \/<\___ \/         | |   /| |_| |\ \/ _ \/     | |       <\___ \/    | | | |<|  \| |>\| |  _ / 
 | |_| |   | |_| | | |___  u___) | u___) |        /| |\  U|  _  |u / ___ \    /| |\       u___) |.-,_| |_| |U| |\  |u | |_| |  
  \____|  <<\___/  |_____| |____/>>|____/>>      u |_|U   |_| |_| /_/   \_\  u |_|U       |____/>>\_)-\___/  |_| \_|   \____|  
  _)(|_  (__) )(   <<   >>  )(  (__))(  (__)     _// \\_  //   \\  \\    >>  _// \\_       )(  (__)    \\    ||   \\,-._)(|_   
 (__)__)     (__) (__) (__)(__)    (__)         (__) (__)(_") ("_)(__)  (__)(__) (__)     (__)        (__)   (_")  (_/(__)__) 
Welcome to 🎤 Guess-that-song! 🎤
1. Play ▶️ 
2. Leaderboard 🏅 
3. Quit 👋
"""))
...
When you’re ready, type any character. """)
    ...
    for num in range(5):
        valid = False
        lyric = lyrics[num]
        guess = input(f"{print_slow(lyrics[num])}\n").lower()
        while valid != True:
            while round_score > 0:
                time.sleep(1)
                round_score -= 1
